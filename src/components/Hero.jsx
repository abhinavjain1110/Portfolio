...
import ComputersCanvas from '../components/canvas/Computers.jsx'
    ...
    return(
        <section className='relative w-full h-screen mx-auto'>
            ...
            <div className='absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center'>
                <a href='#about'>
                    <div className='w-[35px] h-[45]px rounded-3xl border-4 border-white flex justify-center items-start p-2'>
                        <motion.div 
                            animate={{
                                y:[0,10,0]
                            }}
                            ...
                            className='w-3 h-5 rounded-full bg-white mb-1'
                        />
                    </div>
                </a>
            </div>
